	...
	<div class="container">
		<div class="row">
			<div class="col-md-7 offset-md-3">
				<p class="cst-p-mood text-center mb-0">Humeurs de votre semaine</p>
			</div>
		</div>
		<div class="row cst-row-mood">
			
			<div class="col-md-1 offset-md-3">
				<p class="cst-p-mood text-center">L</p>
			</div>
			<div class="col-md-1">
				<p class="cst-p-mood text-center">M</p>
			</div>
			<div class="col-md-1">
				<p class="cst-p-mood text-center">M</p>
			</div>
			<div class="col-md-1">
				<p class="cst-p-mood text-center">J</p>
			</div>
			<div class="col-md-1">
				<p class="cst-p-mood text-center">V</p>
			</div>
			<div class="col-md-1">
				<p class="cst-p-mood text-center">S</p>
			</div>
			<div class="col-md-1">
				<p class="cst-p-mood text-center">D</p>
			</div>
		</div>
		...
		<form id="formMood" action="" method="post">
				...
				<div class="col-md-1 offset-md-3">
					<div class="form-group cst-div-select">
						<select name="selectJ1" class="form-control cst-select-mood" id="select-choice-mood1">
							...
							<option value="4">Fatigué</option>
							<option value="5">Malade</option>
							<option value="6">Triste</option>
							<option value="7">Inquiet</option>
							<option value="8">Amoureux</option>
							<option value="9">Calme</option>
							<option value="10">En colère</option>
						</select>
					</div>
				</div>
			...
			btnMoods>Sauvegardez vos humeurs !</button>
		</form>
